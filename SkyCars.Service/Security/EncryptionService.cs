...
namespace SkyCars.Services.Security
{
    ...
    public class EncryptionService : IEncryptionService
    {
        ...
        public virtual string DecryptText(string cipherText, string encryptionPrivateKey = "")
        {
            ...
            {
                var decryptor = CreateCryptoByType(CryptoType.Decrypt, encryptionPrivateKey);
        ...
        /// <param name="encryptionPrivateKey">Encryption private key</param>
        /// <returns>Encrypted text</returns>
        public string EncryptURLEncoded(string plainText, string encryptionPrivateKey)
        {
        ...
        /// <param name="encryptionPrivateKey">Encryption private key</param>
        /// <returns>Decrypted text</returns>
        public string DecryptURLDecoded(string cipherText, string encryptionPrivateKey)
        {
